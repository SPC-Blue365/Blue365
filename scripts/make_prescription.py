...
<section>
  ...
  <div class="verdict">
    ...
    <p>처방대로 뽑아도 <b>10번 중 약 {(1-pmax)*10:.0f}번은 규격을 벗어납니다.</b>
      계산이 틀린 것이 아니라, <b>계산에 넣는 구역 품위를 정확히 모르기</b> 때문입니다.</p>
    <p>같은 이유로 <b>이 처방은 주 단위로 크게 흔들립니다.</b> 구역 품위를 '그 구역에 최근
      쌓은 물량'으로 추정하는데, 새 적재가 몇 건만 들어와도 그 구역의 추정 품위가 몇 %p씩
      움직이기 때문입니다. 흔들린다는 사실 자체가 <b>아직 믿을 단계가 아니라는 증거</b>입니다.</p>
