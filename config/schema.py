...
#   · "기존/신설" → 한 교대에 두 라인이 모두 가동. 구역코드와 동일한 관례
#     (WITHDRAWAL_SPLIT="equal")에 따라 **균등 배분**한다.
#     ⚠️ 구역과 라인의 위치 대응(예: 구역 45→기존, 70→신설)이라면 배분이 달라진다 —
#        현장 확인 대상. 검증 게이트가 이 행들을 WARNING 으로 계속 노출한다.
LINE_SPLIT_DELIM = "/"
